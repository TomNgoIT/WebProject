<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OnlineShop.Admins.Login" %>
                    ...
                    <table width="94%" border="0" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                            <td height="47" colspan="2" align="center">
                                <asp:Button ID="btnLogon" runat="server" Text="Login" OnClick="btnLogon_Click" Width="63px" />&nbsp;&nbsp;<asp:Button
